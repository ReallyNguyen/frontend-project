        ...
        <div className={`post ${showComment ? 'with-comment' : ''}`}>
            <div className="leftAndRight">
                <div className="leftSide">
                    <div className="vote">
                        <svg class="arrowUp" width="52" height="52" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" onClick={handleUp}>
                        ...
                        <h2>{post.number}</h2>
                        <svg class="arrowDown" width="52" height="52" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleDown}>
